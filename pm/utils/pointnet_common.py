"""
pointmlp,curvenet等用的一些实用程序,在pointnet2_ops中有对应物,但他们还是写了些粗糙的对应物!
我记得有位哥们将当时的三篇关于PointCloud Transformer的实现做了个汇总,里面就有这些!!!
"""
import torch
...
def sample_and_group(npoint, radius, nsample, xyz, points, returnfps=False):
    ...
    """
    new_xyz = index_points(xyz, furthest_point_sample(xyz, npoint))
