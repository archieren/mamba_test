...
from pm.point_transformer.prompt_driven_normalization import PDNorm
...
#我去掉了RPE部分!直接用论文中的xCPE(an Enhanced Conditional Position Encoding).
#直接默认用flash_attention!
